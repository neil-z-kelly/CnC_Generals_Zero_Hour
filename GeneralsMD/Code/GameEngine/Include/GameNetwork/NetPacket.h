...
protected:
	...
	static NetCommandMsg * readFileMessage(UnsignedByte *data, Int &i, Int dataLength);
	static NetCommandMsg * readFileAnnounceMessage(UnsignedByte *data, Int &i, Int dataLength);

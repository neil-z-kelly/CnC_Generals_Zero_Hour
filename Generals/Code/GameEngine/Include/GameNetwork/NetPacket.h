...
protected:
	...
	static NetCommandMsg * readGameMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readAckBothMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readAckStage1Message(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readAckStage2Message(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readFrameMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readPlayerLeaveMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readRunAheadMetricsMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readRunAheadMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readDestroyPlayerMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readKeepAliveMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readDisconnectKeepAliveMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readDisconnectPlayerMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readPacketRouterQueryMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readPacketRouterAckMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readDisconnectChatMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readDisconnectVoteMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readChatMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readProgressMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readLoadCompleteMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readTimeOutGameStartMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readWrapperMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readFileMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readFileAnnounceMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readFileProgressMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readDisconnectFrameMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readDisconnectScreenOffMessage(UnsignedByte *data, Int &i, Int maxLen);
	static NetCommandMsg * readFrameResendRequestMessage(UnsignedByte *data, Int &i, Int maxLen);

	void writeGameMessageArgumentToPacket(GameMessageArgumentDataType type, GameMessageArgumentType arg);
	static Bool readGameMessageArgumentFromPacket(GameMessageArgumentDataType type, NetGameCommandMsg *msg, UnsignedByte *data, Int &i, Int maxLen);
